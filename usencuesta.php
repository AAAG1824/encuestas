    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		?>	
		  ...
		  <h4 class=" mb-4 text-gray-800"><?php echo $sMensajeBienvenida ?></h4>
          <h4 class=" mb-4 text-gray-800">Ingresa la siguiente informaci&oacute;n para contestar la encuesta.</h4>
		  <br>
		  <form class="FrmPreguntas" action="usencuestaval.php" enctype="multipart/form-data" method="post"> 
			 <input name="SS" type="hidden" value="<?php echo $sSS; ?>">
			 <input name="Id" type="hidden" value="<?php echo $iEncuestaId; ?>">
			 <input name="Acc" type="hidden" value="A">
			  <div class="row"> 
        		  <div class="col-lg-12"> 
                 	<div class="form-group row">
                  		<div class="col-sm-2"><label>No. Nomina</label> 
                  <input type="number" class="form-control " id="Nomina" name="Nomina"   required>
						</div>
                  		<div class="col-sm-2"><label>Edad</label> 
                  <input type="number" class="form-control " id="Edad" name="Edad"   required>
			     	...
			     	<select name="Genero" id="Genero"   required   class="form-control"  >
					  ...
					  <option value="2">FEMENINO</option>
                   	...
                   	<strong>	 <input name="submit" type="submit" value="Ingresar"  class="btn btn-primary btn-user btn-block"></strong>
						</div>
