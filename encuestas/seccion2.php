...
<p>&nbsp;</p> 
                <div class="col-md-12">            
                    <p class="list-group-item-heading EstiloN1m"><strong>II.-  Recuerdos persistentes sobre el acontecimiento (durante el último mes):</strong></p>
					...
					<input name="PgI" type="hidden" value="7">
  ...
  <tr>
    <td width="2%"  height="50" align="left" valign="top" class="Estilo1">7-</td>
    <td width="74%" align="left" valign="top" class="Estilo1">¿Ha tenido recuerdos recurrentes sobre el acontecimiento que le provocan malestares?</td>
    <td><div align="center">
      <input name="R7" type="radio" value="1" required>
    </div></td>
    <td><div align="center">
      <input name="R7" type="radio" value="2" required>
    </div></td> 
  </tr>
    <tr>
    <td  width="2%" height="50" align="left" valign="top" class="Estilo1">8.-</td>
    <td width="74%" align="left" valign="top" class="Estilo1">¿Ha tenido sueños de carácter recurrente sobre el acontecimiento, que le producenmalestar?</td>
    <td><div align="center">
      <input name="R8" type="radio" value="1" required>
    </div></td>
    <td><div align="center">
      <input name="R8" type="radio" value="2" required>
    </div></td> 
  </tr>
</table>
<br>
  ...
  <div class="col-md-1"> &nbsp;</div>
    <div class="col-md-10"> 
		...
		<div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Avance del 6%</div>
                        </div>
      
                      <div class="progress progress-sm mr-2">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 6%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                      </div></h6>
