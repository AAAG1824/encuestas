	 ...
	 <td width="60%" align="center" valign="middle"><h3>Factores de riesgo psicosocial en el trabajo <BR>NOM-035-STPS-2018</h3></td>
        ...
        <div class="list-group"  style="height:600px; background:#28B5ED; background-image:url(img/fnd3.png); background-position:center; background-repeat:no-repeat ">
                ...
                <div class="col-md-12">            <p class="list-group-item-heading">&nbsp;</p>
                    <p class="list-group-item-heading EstiloN1m"> <strong>Las preguntas siguientes están relacionadas con el esfuerzo mental que le exige su trabajo.</strong></p>
					...
					<input name="PgI" type="hidden" value="77">
					<input name="Pg" type="hidden" value="80">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">
                        ...
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo1">77.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Mi trabajo exige que esté muy concentrado</td>
                          <td><div align="center">
                              <input name="R77" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R77" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R77" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R77" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R77" type="radio" value="0" required >
                          </div></td>
                        </tr>
                        <tr>
                          <td  width="4%" height="50" align="left" valign="top" class="Estilo1">78.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Mi trabajo requiere que memorice mucha información</td>
                          <td><div align="center">
                              <input name="R78" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R78" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R78" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R78" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R78" type="radio" value="0" required >
                          </div></td>
                        </tr>
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo1">79.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">En mi trabajo tengo que tomar decisiones difíciles muy rápido</td>
                          <td><div align="center">
                              <input name="R79" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R79" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R79" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R79" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R79" type="radio" value="0" required >
                          </div></td>
                        </tr>
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo1">80.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Mi trabajo exige que atienda varios asuntos al mismo tiempo</td>
                          <td><div align="center">
                              <input name="R80" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R80" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R80" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R80" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R80" type="radio" value="0" required >
                          </div></td>
                        </tr>
                      </table>
                      <br>
  ...
  <div class="col-md-1"> &nbsp;</div>
    <div class="col-md-10"> 
		...
		<div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Avance del 57%</div>
                        </div>
      
                      <div class="progress progress-sm mr-2">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 57%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                      </div></h6>
