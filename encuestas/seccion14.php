	 ...
	 <td width="60%" align="center" valign="middle"><h3>Factores de riesgo psicosocial en el trabajo <BR>NOM-035-STPS-2018</h3></td>
        ...
        <div class="list-group"  style="height:600px; background:#28B5ED; background-image:url(img/fnd3.png); background-position:center; background-repeat:no-repeat ">
                ...
                <div class="col-md-12">            <p class="list-group-item-heading">&nbsp;</p>
                    <p class="list-group-item-heading EstiloN1m"><strong>Para responder a las preguntas siguientes piense en la cantidad y ritmo de trabajo que tiene.</strong></p>
					...
					<input name="PgI" type="hidden" value="74">
					<input name="Pg" type="hidden" value="76">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">
                        ...
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo1">74.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Por la cantidad de trabajo que tengo debo quedarme tiempo adicional a mi turno</td>
                          <td><div align="center">
                              <input name="R74" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R74" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R74" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R74" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R74" type="radio" value="0" required >
                          </div></td>
                        </tr>
                        <tr>
                          <td  width="4%" height="50" align="left" valign="top" class="Estilo1">75.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Por la cantidad de trabajo que tengo debo trabajar sin parar</td>
                          <td><div align="center">
                              <input name="R75" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R75" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R75" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R75" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R75" type="radio" value="0" required >
                          </div></td>
                        </tr>
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo1">76.-</td>
                          <td width="61%" align="left" valign="top" class="Estilo1">Considero que es necesario mantener un ritmo de trabajo acelerado</td>
                          <td><div align="center">
                              <input name="R76" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R76" type="radio" value="3" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R76" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R76" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R76" type="radio" value="0" required >
                          </div></td>
                        </tr>
  ...
  <div class="col-md-1"> &nbsp;</div>
    <div class="col-md-10"> 
		...
		<div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Avance del 54%</div>
                        </div>
