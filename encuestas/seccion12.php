...
<p>&nbsp;</p> 
                <div class="col-md-12">            
                   ...
                   <form action="regseccion.php?Is=<?php echo $iSecc;?>&IdE=<?php echo   $IdE;?>&Id=<?php echo   $Id;?>" method="post" enctype="multipart/form-data">
					...
					<input name="PgI" type="hidden" value="65">
					<input name="Pg" type="hidden" value="68">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">
                        ...
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo2">65.-</td>
                          <td width="60%" align="left" valign="top" class="Estilo2">Soy jefe de otros trabajadores:</td>
                          <td colspan="3"><div align="center">
                              <input name="R65" type="radio" value="1" required onClick="Muestra(1)" >
                          </div>                            </td>
                          <td colspan="3"><div align="center">
                            <input name="R65" type="radio" value="2" required checked onClick="Muestra(0)"  >
                          </div></td>
                        </tr></table>
                        ...
                        <tr>
                          <td  width="4%" height="50" align="left" valign="top" class="Estilo2">66.-</td>
                          <td width="60%" align="left" valign="top" class="Estilo2">Dificultan el logro de los resultados del trabajo</td>
                          <td><div align="center">
                              <input name="R66" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R66" type="radio" value="3" required>
                          </div></td>
                          <td colspan="2"><div align="center">
                              <input name="R66" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R66" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R66" type="radio" value="0" required checked="checked">
                          </div></td>
                        </tr>
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo2">67.-</td>
                          <td width="60%" align="left" valign="top" class="Estilo2">Ignoran las sugerencias para mejorar su trabajo</td>
                          <td><div align="center">
                              <input name="R67" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R67" type="radio" value="3" required>
                          </div></td>
                          <td colspan="2"><div align="center">
                              <input name="R67" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R67" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R67" type="radio" value="0" required checked="checked">
                          </div></td>
                        </tr>
                        <tr>
                          <td width="4%" height="50" align="left" valign="top" class="Estilo2">68.-</td>
                          <td width="60%" align="left" valign="top" class="Estilo2">Comunican tarde los asuntos de trabajo</td>
                          <td><div align="center">
                              <input name="R68" type="radio" value="4" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R68" type="radio" value="3" required>
                          </div></td>
                          <td colspan="2"><div align="center">
                              <input name="R68" type="radio" value="2" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R68" type="radio" value="1" required>
                          </div></td>
                          <td><div align="center">
                              <input name="R68" type="radio" value="0" required checked="checked">
                          </div></td>
  ...
  <div class="col-md-1"> &nbsp;</div>
    <div class="col-md-10"> 
		...
		<div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Avance del 40%</div>
                        </div>
