...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-2 text-gray-800">Agregar Encuesta</h1> 
 ...
 <div class="row">
               ...
               <div class="form-group row"> 
                ...
                <div class="form-group row" >
                  ...
                  <div class="col-sm-12">
                	...
                	<textarea name="Bienvenida" id="Bienvenida" class="form-control"  rows="3" required> </textarea>
				  </div>
                </div>
				   <div class="form-group row" >
                  <div class="col-sm-12">
					<label>Mensaje Final</label> 
                	<textarea name="Final" id="Final" class="form-control"  rows="3" required> </textarea>
				  </div>
                </div>
  ...
  <option value="1"   selected   >T0D0S</option>  <option value="2"     >C/NIVEL 2</option>  <option value="3"   >C/NIVEL 3</option> 
